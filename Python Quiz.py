...
#EXTRA:    I made questions shuffle so that it is random, user can choose how many questions they would like to have up to 30 (the pcep has a total of 30).
...
def percent(num):
    result = round((num / original_count) * 100, 2)
    return result
...
line()
try:
    how_many = int(input('  How many questions would you like to be tested on?  (1-30): '))
    if how_many < 1:
        how_many = 1
        space()
        print('An invalid \'minimum\' amount was provided. By default the amount of questions has been set to 1.')
    elif how_many > 30:
        space()
        how_many = 30
        print('An invalid \'maximum\' amount was provided. By default the amount of questions has been set to 30.')
except Exception:
    space()
    how_many = 1
    print('An invalid value was provided. By default the amount of questions has been set to 1.')
line()
original_count = how_many    #this is mean to be the original amount of questions provided based on user input
